...
def main():
    ...
    """
    json_url = 'https://www.stlouis-mo.gov/customcf/endpoints/monarchs/milkweed-gardens-data.cfm?format=json'
    logger.info("Starting JSON fetch demonstration...")
    fetch_json_file(FETCHED_DATA_DIR, "monarchs.json", json_url)
